...
//                     {/* <img src={asset} className="w-32 sm:w-36 mx-auto md:mx-0" alt="Logo" /> */}
//                     <p className="mt-3 text-gray-500 leading-relaxed text-sm sm:text-base">
//                         Forever – Nơi mang đến những sản phẩm thời trang chất lượng và phong cách cho mọi nhà.
//                     </p>
//                 </div>

//                 {/* Company */}
//                 <div className="text-center md:text-left">
//                     <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3">CÔNG TY</h3>
//                     <ul className="space-y-2">
//                         <li className="cursor-pointer hover:text-pink-500 transition-all duration-200">Trang chủ</li>
//                         <li className="cursor-pointer hover:text-pink-500 transition-all duration-200">Về chúng tôi</li>
//                         <li className="cursor-pointer hover:text-pink-500 transition-all duration-200">Giao hàng</li>
//                         <li className="cursor-pointer hover:text-pink-500 transition-all duration-200">Chính sách bảo mật</li>
//                     </ul>
//                 </div>

//                 {/* Contact */}
//                 <div className="text-center md:text-left">
//                     <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3">LIÊN HỆ</h3>
//                     <ul className="space-y-2">
//                         <li className="hover:text-pink-500 cursor-pointer transition-all duration-200">0356724126</li>
//                         <li className="hover:text-pink-500 cursor-pointer transition-all duration-200">lamdv15042005@gmail.com</li>
//                         <li className="hover:text-pink-500 cursor-pointer transition-all duration-200">Instagram</li>
//                     </ul>
//                 </div>
